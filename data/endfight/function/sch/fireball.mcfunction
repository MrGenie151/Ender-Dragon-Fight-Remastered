...
#say haha
execute positioned 0. 0 0. run summon fireball ^ ^ ^.1 {HasVisualFire:0b,ExplosionPower:5b,Motion:[0.0,-1.0,0.0],Tags:["fireball"],Item:{id:"minecraft:dragon_egg",Count:1b}}
execute as @e[tag=fireball] run data modify entity @s Motion set from entity @s Pos
