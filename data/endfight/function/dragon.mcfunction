...
execute as @a[tag=playerMusic,tag=!playerMusicMAD] if entity @s[scores={musicTimer=..0}] run function endfight:music
execute as @a[tag=playerMusicMAD] if entity @s[scores={musicTimer=..0}] run function endfight:music
...
## Play
# Phase 1
execute if entity @s[scores={dragonHealth=..499},tag=!MAD] run tag @s add musicPhase1
...
# MAD
execute if entity @s[scores={dragonHealth=..250}] run tag @s add musicMAD
...
# Non-music
execute if entity @s[scores={dragonHealth=..250},tag=!MAD] run execute in minecraft:the_end as @e[tag=crystal,limit=3] at @s run summon minecraft:end_crystal ~ ~ ~ {Tags:["crystalInit"]}
execute if entity @s[scores={dragonHealth=..250},tag=!MAD] run tag @s add MAD
