...
execute in minecraft:the_end unless entity @e[type=armor_stand,tag=monumentMarker] run summon minecraft:armor_stand 0 200 0 {Tags:["monumentMarker"],Marker:1b,Invisible:1b}
# Debug display
