...
#Handle becoming MAD
execute if entity @s[scores={dragonHealth=0..250},tag=!MAD] run execute in minecraft:the_end as @e[tag=crystal,limit=5] at @s run summon minecraft:end_crystal ~ ~ ~ {Tags:["crystalInit"]}
