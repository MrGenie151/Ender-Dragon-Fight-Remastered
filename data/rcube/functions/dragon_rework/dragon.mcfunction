...
# Handle becoming MAD
execute if entity @s[scores={rcube.dragonRework_dragonHealth=0..250},tag=!dragon_rework.MAD] run execute in minecraft:the_end as @e[tag=rcube.dragonRework_crystal,sort=random,limit=3] at @s run summon minecraft:end_crystal ~ ~ ~ {Tags:["dragon_rework.crystalInit"]}
