...
data merge entity @s {Health:9999f,attributes:[{id:max_health,base:9999}]}
execute store result entity @s attributes[0].base double 1.0 run scoreboard players get DragonHealth EDFR.config
